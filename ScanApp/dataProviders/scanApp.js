...
(function() {
    var provider = app.data.scanApp = new Everlive({
            offlineStorage: true,
            appId: 'qn1mhuwfwu8ej83e',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'scanApp_access_token',
...
// START_CUSTOM_CODE_scanApp
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_scanApp